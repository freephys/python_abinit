...
# Copyright (C) 2001-2009 ABINIT group (LSi)
...
# -v	verbose mode
# -d	handle files in subdirectory instead of all files among [0-9]* 
...
@ALLsourceDir = <. [0-9]*>;	# source file directories including current one
