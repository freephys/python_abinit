...
AR_ABIUTIL=[.src.53_abiutil]lib53_abiutil.olb
...
AR_GEOMOPTIM=[.src.72_geomoptim]lib72_geomoptim.olb
...
AR_IOMPI=[.src.59_io_mpi]lib59_io_mpi.olb
...
abinis.exe : [.src.98_main]abinis.obj $(DEP_ABINIS)
	...
	close optf
	link/exec=abinis.exe [.src.98_main]abinis.obj,[]abinit.opt/opt
...
newsp.exe : [.src.98_main]newsp.obj $(DEP_NEWSP)
	write sys$output " newsp.exe will be made "
	write sys$output " "
	link/exec=newsp.exe [.src.98_main]newsp.obj,$(DEP_NEWSP_LIB)

[.src.98_main]newsp.obj : [.src.98_main]newsp.F90 [.src.10_defs]libdefs.olb
	set default [.src.98_main]
...
[.src.72_geomoptim]lib72_geomoptim.olb :
	$(MMS) [.src.72_geomoptim]descrip.mms
	set default [.src.72_geomoptim]
	$(MMS)
	set default [--]
...
[.src.59_io_mpi]lib59_io_mpi.olb :
	$(MMS) [.src.59_io_mpi]descrip.mms
	set default [.src.59_io_mpi]
	$(MMS)
	set default [--]
...
[.src.53_abiutil]lib53_abiutil.olb :
        $(MMS) [.src.53_abiutil]descrip.mms
        set default [.src.53_abiutil]
        $(MMS)
        set default [--]
...
[.src.53_abiutil]descrip.mms : crea_descrip_mms.exe
        set def [.src.53_abiutil]
        run [--]crea_descrip_mms
        set def [--]
...
[.src.59_io_mpi]descrip.mms : crea_descrip_mms.exe
	set def [.src.59_io_mpi]
	run [--]crea_descrip_mms
	set def [--]
...
[.src.72_geomoptim]descrip.mms : crea_descrip_mms.exe
	set def [.src.72_geomoptim]
	run [--]crea_descrip_mms
	set def [--]
