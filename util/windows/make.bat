...
rem This file will run several abinis built-in tests in a DOS/Windows box
rem in the same manner than "make tests" under unix.
rem The "run-basic-tests.pl" perl script is called; this one will start abinis
...
rem Copyright (C) 1999-2009 ABINIT group (LSi)
rem This file is distributed under the terms of the
rem GNU General Public License, see ~ABINIT/Infos/copyright
